...
# source://rubocop-no_sorbet//lib/rubocop/cop/no_sorbet/no_mixes_in_class_methods.rb#6
class RuboCop::Cop::NoSorbet::NoMixesInClassMethods < ::RuboCop::Cop::Base
  extend ::RuboCop::Cop::AutoCorrector

  # source://rubocop-no_sorbet//lib/rubocop/cop/no_sorbet/no_mixes_in_class_methods.rb#17
  def def_self_included?(param0 = T.unsafe(nil)); end

  # source://rubocop-no_sorbet//lib/rubocop/cop/no_sorbet/no_mixes_in_class_methods.rb#13
  def mixes_in_class_methods?(param0 = T.unsafe(nil)); end

  # source://rubocop-no_sorbet//lib/rubocop/cop/no_sorbet/no_mixes_in_class_methods.rb#24
  def on_send(node); end
end

# source://rubocop-no_sorbet//lib/rubocop/cop/no_sorbet/no_mixes_in_class_methods.rb#11
RuboCop::Cop::NoSorbet::NoMixesInClassMethods::MSG = T.let(T.unsafe(nil), String)

# source://rubocop-no_sorbet//lib/rubocop/cop/no_sorbet/no_mixes_in_class_methods.rb#9
RuboCop::Cop::NoSorbet::NoMixesInClassMethods::RESTRICT_ON_SEND = T.let(T.unsafe(nil), Array)
